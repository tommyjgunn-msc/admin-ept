...
export default function EditTest() {
  ...
  if (error) return (
    <div className="min-h-screen flex items-center justify-center">
      <p className="text-ftm-ochre">Error: {error}</p>
    </div>
  );
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="border border-ftm-line2 text-ftm-ink px-4 py-2.5 font-inter font-semibold text-[14px] hover:bg-ftm-up transition-colors"
              >
                Preview Test
              </button>
              <button
